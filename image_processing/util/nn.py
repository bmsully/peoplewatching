...
imgs = np.zeros((num_imgs, img_width, img_height))  # set background to 0
...
# 
i = 0
plt.imshow(imgs[i].T, cmap='Greys', interpolation='none', origin='lower', extent=[0, img_width, 0, img_height])
...
for i_subplot in range(1, 5):
    ...
    plt.imshow(test_imgs[i].T, cmap='Greys', interpolation='none', origin='lower', extent=[0, img_width, 0, img_height])
